...
execute if score UHC uhcState matches 4 if score UHCConduit uhcEnabled matches 1 at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:1, Duration:20, potion_contents:{potion:"water",custom_effects:[{id:conduit_power,show_particles:false,duration:2000}]}}