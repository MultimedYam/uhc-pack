...
summon minecraft:armor_stand ~ 251 ~ {Tags:[lobby,lobbycenter],NoGravity:1b,Small:1b,Invisible:1b,CustomNameVisible:1b,CustomName:[{"text":"UHC","color":"gold"},{"text":" \\u2503 ","color":"gray"},{"text":"Lobby","color":"aqua"}]}
